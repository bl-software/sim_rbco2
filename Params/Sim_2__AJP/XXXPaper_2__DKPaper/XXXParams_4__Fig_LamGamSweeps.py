...
'oos_tort_lambda': (('Tort Lambda Vesicles (1/𝜆)', 'oos_tort_lambda', pos_float, '{}', 2, 'Intracellular Fluid (ICF)', 'tb', lams         , None, ()), {}),
     'tort_gamma': (('Tort Gamma VitMem (1/𝛄)'   , 'tort_gamma'     , pos_float, '{}', 2, 'Intracellular Fluid (ICF)', 'tb', gams         , None, ()), {}),
}
