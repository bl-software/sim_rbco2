...
totalruns  = 82
nbreaks    = math.ceil(totalruns/maxperbreak)
#fulllogspace=list(np.logspace(-2.5,1.5,totalruns))
pts41_sig=    list(np.logspace(-3,1.5,41))
full_82pt_sig=list(np.logspace(-3,1.5,totalruns))
...
#GBs= ['C57BL/6Case_Ctrl_6J_Pan', 'C57BL/6J_Pan', 'C57BL/6Case_Ctrl_BalbC_Pan', 'BalbC/J_Pan', 'CAST/EIJ', 'AE1', 'C57BL/6Case_RXO', 'Human', 'Bovine']
#GTs= ['WT', 'WT-m', 'WT-f', 'Bovine', 'Human_FemaleN4', 'Human_MaleN11', 'Human_AvgN15','C57BL/6J_HumanCtrl', 'Het']
