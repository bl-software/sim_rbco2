...
# TODO make single functions combined with "combine_gamlam.py"
class Fig(AJP2014_Fig):
    def __init__(self,sim_results,*args,**kwargs):
        ...
        sweepvarname= sr.get_run_var(-1, 'SweepVar')[0] # 'tort_gamma', 'oos_tort_lambda'
        ...
        self.fp.plot_d={ 'remborder': ['top','right']  ,
                         'tickspos' : 'bottom', }
        self.fp.title=f'AJP LamGam Sweep {xlabel}\n{titlerunpart}'
        ...
        ttp_ylims=(0.0,20.0)
        ax_ttpeakphs.set_ylim(ttp_ylims)

        td_ylims=(0.0,18.0)
        ax_tdelayphi.set_ylim(td_ylims)
