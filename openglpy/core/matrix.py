...
class Matrix(object):
    ...
    @staticmethod
    def makePerspective(angleOfView=60, aspectRatio=1, near=1.0, far=1000):
    ...
    def makeLookAt(position, target):
        ...
        # if forward and worldUp vectors are paralle, right vector is zero
        ...
        #all vectors should have lenght 1
