...
% the ODE solver
function [time,X] = Simulate_CO2_All(sim_type,prog_title,sim_dir,sim_filename_base)
fprintf('*******************************************\n')
fprintf('* In Simulate_CO2_All.m *\n')
fprintf('*******************************************\n')
