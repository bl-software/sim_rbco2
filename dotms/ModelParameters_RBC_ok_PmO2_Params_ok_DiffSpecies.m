...
Species = 'Human'; % WT_Case, WT_C57BL/6J, Bovine, Human
...
if strcmp(Species,'WT_Case')
    % Original WT
    R = 1.01e-4;   % 0.000101 cm 0.00000101 m  1.01 µm Radius of the cell in cm 
    Hbtot_in = 18.73; % mM
    k_lysate = 11.60;
    
elseif strcmp(Species,'WT_C57BL/6J')
    R = 0.96e-4;   % ??? Radius of the cell in cm 
    Hbtot_in = 20.60; % mM
    k_lysate = 11.31;
    
elseif strcmp(Species,'Bovine')
    R = 0.83e-4;   % ??? (=0.99 assuming to have diam of WT_Case) Radius of the cell in cm 
    Hbtot_in = 20.03; % mM
    k_lysate = 10.76; %????
 
elseif strcmp(Species,'Human')
    R = 1.22e-4;   % Radius of the cell in cm 
    Hbtot_in = 20.60; % mM
    k_lysate = 10.76;
...
R_inf  = R + 1e-4;  % 0.000201 cm  0.00000201 m 2.01 µm Radius of the computational domain in cm
