...
% D. Calvetti & E. Somersalo, 2012

function [L b_inf] = SingleSpeciesDiffMatDistr(n_in,n_out,R,R_inf,kappa_in,kappa_out,alpha)

% Computing the inside diffusion matrix ...

[L_in c_in] = DiffusionMatrixInsideDistr(n_in,R,kappa_in,alpha);

% ... and the outside diffusion matrix

[L_out c_out b_vec] = DiffusionMatrixOutsideDistr(n_out,R,kappa_out,alpha,R_inf);
