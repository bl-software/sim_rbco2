...
% (1) integrated concentrations of HbO2 and Hb (in units of mM) 
...
%load Sims_ArithMean/sim3_1p01um_18p73Hb_WT
%load Sims_ArithMean/sim3_1p04um_17p71Hb_AQP1_KO
% %load Sims/sim_1p09um_17p87Hb_RhAG_KO_P50
% %load Sims/sim_1p07um_18p16Hb_dKO_P50
...
myaux1 = find(y >= y_37,1,'last'); % find the values of y that are greater or equal than the y_37pc and identify the largest index in the vector 
myaux2 = myaux1+1;
