...
%            alpha        : Fick's constant across the membrane
%--------------------------------------------------------------------------
% CALLS TO: DiffusionMatrixInsideDistr.m, DiffusionMatrixOutsideDistr.m
%--------------------------------------------------------------------------


function [L b_inf] = SingleSpeciesDiffMatDistr_RBC(n_in,n_out,R,R_inf,kappa_in,kappa_out,alpha)

fprintf('*       In SingleSpeciesDiffMatDistr_RBC.m *\n')
% Computing the inside diffusion matrix ...

[L_in c_in] = DiffusionMatrixInsideDistr_RBC(n_in,R,kappa_in,alpha);

% ... and the outside diffusion matrix

[L_out c_out b_vec] = DiffusionMatrixOutsideDistr_RBC(n_out,R,kappa_out,alpha,R_inf);
...
fprintf('*       Out SingleSpeciesDiffMatDistr_RBC.m *\n')
